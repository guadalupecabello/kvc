...
<nav class="navbar navbar-default barraNavegacion" role="navigation">
  ...
  <div class="navbar-header">
    ...
    <a class="navbar-brand " href="index.php">
      <img src="../i/kelLog.png" height="23" width="23"/><b>CTS</b>
  </a>
  </div>
        ...
        <ul class="nav navbar-nav">
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
               ...
               <? 
                  if($_SESSION['modulos']['out']->lectura == true){
               ?>
               ...
               <? 
                  if($_SESSION['modulos']['ovh']->lectura == true){
               ?>
               ...
               <? 
                  if($_SESSION['modulos']['dxd']->lectura == true){
               ?>
               ...
               <? 
                  if($_SESSION['modulos']['inb']->lectura == true){
               ?>
               ...
               <? 
                  if($_SESSION['modulos']['tpl']->lectura == true){
               ?>
               ...
               <? 
                  if($_SESSION['modulos']['ren']->lectura == true){
               ?>
